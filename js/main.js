/**
 * Entrep Altermark AS - Main JavaScript
 * Industrial Groundwork Website
 */
...
(function() {
    ...
    function initScrollAnimations() {
        const animatedElements = document.querySelectorAll('.service-card, .feature-card, .value-card, .project-card, .contact-card, .equipment-card');
